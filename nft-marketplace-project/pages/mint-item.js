...
import {create as ipfsHttpClient, ipfsClient} from 'ipfs-http-client'
import { nftaddress, nftmarketaddress, projectId, projectSecret } from '../config'
...
description:''})
    ...
    async function createSale(url) {
        ...
        console.log("Create Sale",nftaddress, tx);
